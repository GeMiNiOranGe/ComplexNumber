...
int main() {
    ...
    std::cout << ">>> Demonstration of Complex Number Subtraction <<<" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "We perform several subtraction operations:" << std::endl;
    ...
    std::cout << "Now testing subtraction-assignment:" << std::endl;
